...
while 1
    ...
    disp('* enter ) - (trainscg): Algoritmo de entrenamiento por defecto. *');
    disp('*****************************************************************');
...
net = patternnet(hiddenLayerSize, alg_train);
% =============================================================
...
while 1
    ...
    for x = 1:3
        pront_input = strcat(' - Introduca el % del conjunto de datos', aux_pron(x));
